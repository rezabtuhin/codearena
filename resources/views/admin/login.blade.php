    ...
    <div class="h-[100vh] w-[100vw] flex p-5">
        <div class="bg-white border-all-custom shadow-custom border-top-custom w-[500px] max-w-[700px] mx-auto my-auto">
            <div id="default-tab-content">
                <h1 class="text-center"><span class="text-[25px] uppercase"><span class="text-primary font-black">Code</span>Arena</span> <sup class="text-sm text-primary">admin</sup></h1>
                <div class="p-4">
                ...
                <div class="px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel"
                     aria-labelledby="profile-tab">
                    <form action="{{ route('admin.login.new') }}" method="post">
                        @csrf
                        @method('POST')
